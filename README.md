...
[![GitHub license](https://img.shields.io/github/license/ProTerUg/DonationAlertsAPI)](https://github.com/ProTerUg/DonationAlertsAPI/blob/main/LICENSE)
...
1. Download the latest JAR file from the [Releases](https://github.com/ProTerUg/DonationAlertsAPI/releases) page or from [Modrinth](https://modrinth.com/plugin/donationalertsapi).
